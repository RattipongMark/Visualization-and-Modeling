...
-   [Churn : เลขที่บอกถึงการ Churn ของลูกค้าโดย 0
    ...
    หมายถึงลูกค้ายกเลิกการเป็นสมาชิกของบริษัทไปแล้ว]
...
-   [CityTier : ระดับของพฤติกรรมในการบริโภคของประชากรในเมืองนั้น
    โดยจะมีตั้งแต่ระดับ 1 ไปจนถึง ระดับ 3]
...
-   [NumberOfAddress : จำนวนที่รวมอยู่ของลูกค้า]

-   [Complain : ลูกค้าได้มีการ complain หรือไม่ในเดือนก่อนหน้าโดย 0 หมายถึง ไม่มีการ
    complain เลยในเดือนก่อนหน้า 1 หมายถึงมีการ complain ในเดือนก่อนหน้า]

-   [OrderAmountHikeFromlastYear : จำนวน order
    รวมที่ลูกค้ารายนี้สั่งเพิ่มขึ้นจากปีที่แล้วคิดเป็นเปอร์เซ็นต์]
...
มีค่าว่างหรือไม่]
<img src="media/image2.png" width="2.2587248468941383in"
height="2.5049365704286966in"/>

[]![](media/image3.png){width="2.3566786964129482in"
...
-   [ตรวจสอบคอลัมน์ที่ไม่มีค่า และวิเคราะห์ข้อมูล\
    \
    ]![](media/image4.png){width="2.281324365704287in"
...
-   [เติมข้อมูลส่วนที่หายไป\
    \
    ]![](media/image6.png){width="4.338542213473316in"
...
height="1.147866360454943in"} []

[จากนั้นจะทำการแบ่งคอลัมน์เป็นสองประเภทคือ Categorical และ Numerical
โดยแยกจากชนิดข้อมูลที่เป็น object หรือไม่]
...
1.  *[Univariate Analysis]*
    ...
    1.  [Categorical Data]
        ...
        1.  [Churn : กราฟแสดงสัดส่วนของสถานะการ Churn ของลูกค้า]
...
3.  *[Churn Analysis]*
    ...
    1.  [Categorical Data]
        ...
        1.  [Preferred Login Device : ในกลุ่มลูกค้าที่ใช้ Mobile phone
            ...
            \
            \
            ]![](media/image28.png){width="3.3988003062117236in"
        ...
        2.  [City Tier :\
            ...
            \
            ]![](media/image29.png){width="3.3802088801399823in"
        ...
        3.  [PreferredPaymentMode :\
            ...
            \
            ]![](media/image30.png){width="3.4739588801399823in"
        ...
        4.  [Gender : ในกลุ่มผู้ใช้งานที่เป็นผู้หญิงมีคนที่ Churn ทั้งหมด 348 คนและไม่
            ...
            \
            ]![](media/image31.png){width="3.390577427821522in"
        ...
        6.  [Preferred Order Cat :\
            ...
            \
            ]![](media/image32.png){width="3.3199726596675414in"
        ...
        8.  [Martial Status :\
            ...
            \
            ]![](media/image33.png){width="3.3209022309711287in"
            height="2.810764435695538in"}
        ...
        9.  [Complain : ในกลุ่มลูกค้าที่ไม่ได้ Complain มีคนที่ Churn ทั้งหมด 440 คน
            ...
            \
            ]![](media/image34.png){width="3.276042213473316in"
...
5.  [SatisfactionScore : จากกราฟจะเห็นได้ว่าโอกาสการ Churn จะมีมากที่สุดเมื่อ
    คะแนนมีค่าเท่ากับ 3\
    \
    ]![](media/image39.png){width="2.9393208661417325in"
...
6.  [NumberOfAddress : โอกาสการ Churn มีมากเมื่อจำนวนที่อยู่น้อย
    ...
    \
    ]![](media/image40.png){width="2.9346423884514437in"
...
7.  [OrderAmountHikeFromLastYear : ​\
    ...
    ลดลง\
    \
    ]![](media/image41.png){width="3.037141294838145in"
    height="2.6093755468066493in"} []
...
9.  [OrderCount : ในช่วงที่มีจำนวน order น้อย โอกาสการ Churn จะมากว่า ช่วงที่
    order เยอะ\
    \
    ]![](media/image43.png){width="3.0729166666666665in"
    height="2.6354166666666665in"}

10. [DaySinceLastOrder : เมื่อจำนวนวันมากขึ้น แนวโน้มการ Churn จะลดลง\
    \
    ]![](media/image44.png){width="3.2968755468066493in"
...
-   [ข้อมูลที่มี data type เป็น object จะใช้ฟังก์ชัน get_dummies เพื่อทำการแยกเป็น
    ...
    แล้วรวมเข้าด้วยกัน]![A screenshot of a computer Description
    automatically
...
-   [ใช้ library sklearn เพื่อแบ่งข้อมูลสำหรับการ train และ test โดยกำหนดให้
    มีอัตราส่วนเป็น 70:30]

<!-- -->

-   [จากนั้นทำการ plot decision tree]![A screenshot of a computer
    Description automatically
...
-   [ทำการหาค่า feature important พบว่าข้อมูลจาก column "Tenure"
    มีอิทธิพลต่อการตัดสินใจมากที่สุด]![A screenshot of a computer
    Description automatically
    generated](media/image50.png){width="6.267716535433071in"
    height="1.8194444444444444in"}

-   [Classification report ให้ค่า accuracy อยู่ที่ 0.89]![A screenshot
...
-   [ทำการ import Logistic Regression model กำหนดค่า max_iter ไว้ที่ 10,000
    เพื่อให้ algorithm ของ model มีเวลาคำนวณมากขึ้น]![A computer screen
    with text and numbers Description automatically
    generated](media/image52.png){width="6.267716535433071in"
    height="1.6944444444444444in"}

-   [Classification report ให้ค่า accuracy อยู่ที่ 0.90]![A screenshot
...
-   [Classification report ให้ค่า accuracy อยู่ที่ 0.87]![A screenshot
    of a computer program Description automatically
...
-   [ทำการ import RandomForestClassifier เพื่อเรียกใช้ model จากนั้นเลือกใช้เกณฑ์
    ...
    bootstrap = True]![A screen shot of a computer Description
    automatically
    generated](media/image55.png){width="6.267716535433071in"
    height="2.388888888888889in"}

-   [Classification report ให้ค่า accuracy อยู่ที่ 0.96]![A screenshot
    of a computer Description automatically
    generated](media/image56.png){width="6.267716535433071in"
    height="1.7777777777777777in"}

-   [ทำการสร้าง confusion matrix เพื่อดูผลการ predict]![A screenshot
    of a computer program Description automatically
...
decision tree ที่จะถนัดกับความสัมพันธ์แบบ non-linear มากกว่า]
...
ทั้งหมด จะพบว่า model แบบ Random Forest จะให้ค่า accuracy ที่สูงที่สุด]
